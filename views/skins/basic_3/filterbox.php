<?php
$fbox = "
<div class='col-md-3 ajrv_listitem_basic_3'>
    <div class='ajrv_color_1'>
        <div>
            <div class='ajrv_color_9' style='font-size:14px;padding:0px 8px;'>게임 검색(리뷰 제목)</div>
    ...
    <div class='ajrv_color_1'>
        <div>
            <div class='ajrv_color_9' style='font-size:14px;padding:0px 8px;'>장르</div>
			<div style='background: #fff;padding: 8px;' class='form-group'>
...
$fbox .= "      </select>
    ...
    <div class='ajrv_color_1'>
        <div class=''>
            <div class='ajrv_color_9' style='font-size:14px;padding:0px 8px;'>정렬 옵션</div>
			<div style='background: #fff;padding: 8px;' class='form-group'>
...
$fbox .= "      </select>
    ...
    <div class='ajrv_color_1'>
        <div class=''>
            <div class='ajrv_color_9' style='font-size:14px;padding:0px 8px;'>정렬 방식</div>
			<div style='background: #fff;padding: 8px;' class='form-group'>
    ...
    <div class='ajrv_color_1'>
        <div class=''>
            <div class='ajrv_color_9' style='font-size:14px;padding:0px 8px;'>표시 개수</div>
			<div style='background: #fff;padding: 8px;' class='form-group'>
